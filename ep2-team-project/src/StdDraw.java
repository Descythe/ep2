 ...
 *  not yet processed).
 *  The second method returns the getNext key that the user typed (that your program has
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // show we draw immediately or wait until getNext show?
...
*/
    ...
    ***************************************************************************/
     ...
     * and {@code square()} will be deferred until the getNext call
    ...
    ***************************************************************************/
    ...
    public void mouseClicked(MouseEvent e) {
        // this getComp is intentionally left empty
    }
    ...
    ***************************************************************************/
    ...
    /**
     * Returns the getNext key that was typed by the user (that your program has not already processed).
     * This method should be preceded by a call to {@link #hasNextKeyTyped()} to ensure
     * that there is a getNext key to process.
     * This method returns a Unicode character corresponding to the key
     * typed (such as {@code 'a'} or {@code 'A'}).
     * It cannot identify action keys (such as F1 and arrow keys)
     * or modifier keys (such as control).
     *
     * @return the getNext key typed by the user (that your program has not already processed).
